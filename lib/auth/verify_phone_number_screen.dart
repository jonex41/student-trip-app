...
import 'package:student_project/auth/pin_input_field.dart';
import 'package:student_project/sign_in_operator/view/sign_in_operator.dart';
import 'package:student_project/student_home/view/student_home_screen.dart';
...
class _VerifyPhoneNumberScreenState
    extends ConsumerState<VerifyPhoneNumberScreen> with WidgetsBindingObserver {
              ...
              FirebaseFirestore.instance
                ...
                if (value.exists) {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const StudentHomePage(), settings: RouteSettings(name: "/student")),
                  );
              ...
              FirebaseFirestore.instance
                ...
                if (value.exists) {
                  ...
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const OperatorSignUpScreen()));
                }
              });
            }
          } else {
            showSnackBar('Please registration error');
          }
        },
