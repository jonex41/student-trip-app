...
import 'package:student_project/auth/operator_home/view/my_bookings.dart';
...
import '../../../vehicle/view/create_vehicle.dart';
import '../../../vehicle/view/vehicle_details.dart';

class OperatorHomePage extends HookConsumerWidget {
                ...
                InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const OperatorBookingPage()),
                    );
                  },
                  child: Container(
                    height: 200,
